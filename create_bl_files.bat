...
%COMMANDER% gbl create "%PATH_GBL%\slot_storage.gbl.bin" --app "C:\Users\lamadsen\SimplicityStudio\AQ\mgm240_soc_empty\GNU ARM v10.2.1 - Default\mgm240_soc_empty.s37" --compress lzma
del /Q "C:\Users\lamadsen\Dropbox (Silicon Labs)\__FIRMWARE\*.*"
copy C:\Users\lamadsen\SimplicityStudio\AQ\mgm240_soc_empty\output_gbl\slot_storage.gbl.bin "C:\Users\lamadsen\Dropbox (Silicon Labs)\__FIRMWARE"
